...
12 TB + XX TB      `north/coadd/`_ + `south/coadd/`_         Coadded images (image stacks)
8.4 GB + XXX GB    `north/external/`_ + `south/external/`_   Matches to other catalogs (SDSS, etc.)
XXX MB             `gallery/`_                               Notable images (e.g. NGC galaxies)
9.6 GB + XXX GB    `north/logs/`_ + `south/logs/`_           Log files generated by `Tractor`_ processing
288 GB + XXX GB    `north/metrics/`_ + `south/metrics/`_     Metrics and statisics of Tractor fits
XXX GB	           `randoms/`_                               Catalogs of random points
153 GB + XXX GB    `north/sweep/`_ + `south/sweep/`_         Subsets of the Tractor `catalogs`_
479 GB + XXX TB    `north/tractor/`_ + `south/tractor/`_     The Tractor `catalogs`_
================== ========================================= =================================
