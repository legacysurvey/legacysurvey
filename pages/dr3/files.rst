...
Top level directory for web access to dr3.1 sweeps (see `known issues`_ 
for a description of dr3.1):
...
Top level directory local to NERSC computers for dr3.1 sweeps (see `known issues`_ 
for a description of dr3.1):
