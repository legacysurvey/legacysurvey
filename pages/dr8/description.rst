...
XXX + XXX TB  `north/coadd/`_ + `south/coadd/`_         Coadded images (image stacks)
XXX + XXX GB  `north/external/`_ + `south/external/`_   Matches to other catalogs (SDSS, etc.)
XXX MB        `gallery/`_                               Notable images (e.g. NGC galaxies)
XXX + XXX GB  `north/logs/`_ + `south/logs/`_           Log files generated by `Tractor`_ processing
XXX + XXX GB  `north/metrics/`_ + `south/metrics/`_     Metrics and statisics of Tractor fits
XXX GB	      `randoms/`_                               Catalogs of random points
XXX + XXX GB  `north/sweep/`_ + `south/sweep/`_         Subsets of the Tractor `catalogs`_
XXX + XXX TB  `north/tractor/`_ + `south/tractor/`_     The Tractor `catalogs`_
============= ========================================= =================================
