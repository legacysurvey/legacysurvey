...
``lc_flux_w1``                        float32[11]  nanomaggy             ``flux_w1`` in each of up to eleven unWISE coadd epochs (AB system)
``lc_flux_w2``                        float32[11]  nanomaggy             ``flux_w2`` in each of up to eleven unWISE coadd epochs (AB)
``lc_flux_ivar_w1``                   float32[11]  1/nanomaggy\ |sup2|   Inverse variance of ``lc_flux_w1`` (AB system)
``lc_flux_ivar_w2``                   float32[11]  1/nanomaggy\ |sup2|   Inverse variance of ``lc_flux_w2`` (AB)
