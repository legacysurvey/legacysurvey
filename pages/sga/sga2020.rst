...
The Siena Galaxy Atlas 2020 (SGA-2020) data products can be browsed and
downloaded at the `SGA web-portal`_, both for individual galaxies and
the full sample. Below, we outline the data model for these data products.
The SGA-2020 is described in detail in `Moustakas, Lang, et al. (2023)`_.
...
.. _`Moustakas, Lang, et al. (2023)`: https://ui.adsabs.harvard.edu/abs/2023arXiv230704888M/abstract
