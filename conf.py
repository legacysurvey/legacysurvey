...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/.", 'Home'),
        ((
            ("/dr6/description", 'Description'),
            ("/dr6/files", 'Files'),
            ("/dr6/catalogs", 'Catalogs'),
            ("/dr6/issues", 'Known Issues'),
            ), 'DR6'),
        ((
            ("/dr1", 'Data Release 1'),
            ("/dr2", 'Data Release 2'),
...
#            ("http://batc.bao.ac.cn/BASS", 'BASS'),
        ...
        ("http://portal.nersc.gov/project/cosmo/data/legacysurvey/dr6/gallery/", 'Gallery'),
        ("/status", 'Status'),
        ("/pubs", 'Publications'),
